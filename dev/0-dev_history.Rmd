...
fusen::fill_description(
  ...
  fields = list(
    Title = "pevrdc",
    Description = "An internal package to streamline immunization and surveillance analysis of DRC data without any dependency.",
    `Authors@R` = c(
      person("Benedict", "Nguimbis", email = "nguimbisb@who.int", role = c("aut", "cre")),
      person("Celestin", "Danwang", email = "danwangc@who.int", role = c("rev", "ctb") ),
      person("Cedric", "Nwanga", email = "mwangac@who.int", role = c("dtc")),
      person("Franck", "Mboussou", email = "mboussouf@who.int", role = c("ths", "cph"))
    )
  ), overwrite = T
)
# Define License with use_*_license()
usethis::use_proprietary_license("World Health Organization")
```
